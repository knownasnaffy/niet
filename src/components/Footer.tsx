    ...
    <footer className="bg-ink text-on-ink pt-xxl border-t border-ink-soft">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-xl w-full px-lg py-xxl max-w-max-width mx-auto">
        <div className="md:col-span-1">
          <Link
            href="/"
            className="text-display-xs font-display-xs text-on-ink block mb-lg"
          >
            NIET
          </Link>
          <p className="text-caption-md opacity-70 mb-xl">
            Shaping the future of engineering education with innovation,
            research, and technical excellence.
          </p>
          <div className="flex gap-md">
            <span className="material-symbols-outlined cursor-pointer hover:text-primary-bright">
              social_leaderboard
            </span>
            <span className="material-symbols-outlined cursor-pointer hover:text-primary-bright">
              public
        ...
        <div>
          ...
          <ul className="space-y-sm text-caption-md">
            <li>
              <Link
                className="opacity-70 hover:opacity-100 hover:text-primary-bright transition-opacity"
                href="/apply-online"
              >
                Apply Now
              </Link>
        ...
        <div>
          ...
          <ul className="space-y-sm text-caption-md">
            <li>
              <Link className="text-on-ink font-bold" href="/academic-calendar">
                Academic Calendar
              </Link>
            </li>
            <li>
      ...
      <div className="bg-ink-deep py-lg border-t border-ink-soft">
        <div className="max-w-max-width mx-auto px-lg text-center md:text-left text-caption-md opacity-70">
          © 2024 Northvale Institute of Engineering &amp; Technology. All rights
          reserved.
        </div>
      </div>
    </footer>
