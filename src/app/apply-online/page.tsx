      ...
      <main className="max-w-max-width mx-auto px-lg py-section min-h-[calc(100vh-64px)]">
        <div className="mb-section">
          <div className="relative flex justify-between items-start max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-sm">
              <div className="w-10 h-10 rounded-full bg-canvas border-2 border-fog text-secondary flex items-center justify-center font-bold">
                2
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl items-start">
          <div className="lg:col-span-8 bg-canvas rounded-xl shadow-[0_2px_8px_rgba(26,26,26,0.08)] p-xxl relative overflow-hidden">
            ...
            <div className="mb-xl">
              <h1 className="font-display-md text-display-md text-ink mb-xs">
                Personal Information
              </h1>
              <p className="text-body-md text-on-surface-variant">
                Please provide your primary contact and family details as per
            ...
            <form className="space-y-xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-xl">
                <div className="flex flex-col gap-xs">
                  <label className="font-caption-bold text-ink" htmlFor="name">
                    Full Name (As per High School Certificate)
                  </label>
                  <input
                    className="h-11 rounded-lg border-steel focus:border-ink focus:ring-0 transition-all px-md font-body-md text-ink placeholder:text-outline"
                    id="name"
                ...
                <div className="flex flex-col gap-xs">
                  <label className="font-caption-bold text-ink" htmlFor="email">
                    Email Address
                  </label>
                  <input
                    className="h-11 rounded-lg border-steel focus:border-ink focus:ring-0 transition-all px-md font-body-md text-ink placeholder:text-outline"
                ...
                <div className="flex flex-col gap-xs">
                  <label className="font-caption-bold text-ink" htmlFor="phone">
                    Phone Number
                  </label>
                  <div className="flex gap-xxs">
                    <span className="h-11 flex items-center px-sm bg-cloud border border-steel rounded-lg text-secondary font-body-md">
                      +91
                    </span>
                    <input
                      className="h-11 flex-1 rounded-lg border-steel focus:border-ink focus:ring-0 transition-all px-md font-body-md text-ink placeholder:text-outline"
                      id="phone"
                ...
                <div className="flex flex-col gap-xs">
                  <label
                    className="font-caption-bold text-ink"
                    htmlFor="father"
                  >
                    Father&apos;s Name
                  </label>
              ...
              <div className="flex flex-col gap-xs">
                <label className="font-caption-bold text-ink" htmlFor="address">
                  Permanent Address
                </label>
                <textarea
                  className="rounded-lg border-steel focus:border-ink focus:ring-0 transition-all p-md font-body-md text-ink placeholder:text-outline resize-none"
                  id="address"
              ...
              <div className="pt-lg flex items-center justify-between border-t border-fog">
                <p className="text-caption-sm text-secondary italic">
                  Step 1 of 4: Personal Information
                </p>
                <button
                  className="bg-primary hover:bg-primary-deep text-on-primary font-button-md h-11 px-xxl rounded transition-all active:scale-95 flex items-center gap-sm"
                  type="submit"
                >
          ...
          <aside className="lg:col-span-4 space-y-lg">
            <div className="bg-ink rounded-xl p-xl text-on-ink relative overflow-hidden group">
              <div className="relative z-10">
                ...
                <p className="font-caption-md opacity-80 mb-xl">
                ...
                <div className="space-y-lg">
                  <div className="flex items-start gap-md">
                    ...
                    <div>
                      ...
                      <p className="font-body-md text-primary-soft">
                        +91 123 456 7890
                      </p>
                    </div>
                  </div>
