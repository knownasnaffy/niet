...
<span className="material-symbols-outlined text-[48px] text-primary" data-icon="mark_email_read">mark_email_read</span>
</div>

<h1 className="font-display-sm text-display-sm font-bold text-ink mb-sm">Check your email</h1>
...
<p className="font-caption-md text-caption-md text-charcoal mb-xs">Didn&apos;t receive the email?</p>
