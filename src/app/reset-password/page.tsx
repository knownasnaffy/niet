        ...
        <div className="w-full max-w-[480px] bg-canvas rounded-xl shadow-[0_2px_8px_rgba(26,26,26,0.08)] p-xxl relative z-10 border border-fog">
          ...
          <form className="space-y-xl">
            <div className="space-y-xs">
              <label
                className="font-body-emphasis text-body-emphasis text-charcoal"
              ...
              <div className="relative">
                <input
                  className="w-full h-[44px] px-md border border-steel rounded-[4px] focus:border-ink focus:ring-0 text-body-md font-body-md transition-colors outline-none pr-12"
                  id="new_password"
                  placeholder="Min. 12 characters"
                  type="password"
                />
                <button
                  className="absolute right-md top-1/2 -translate-y-1/2 text-graphite hover:text-ink transition-colors"
                  type="button"
                >
                  <span
              ...
              <div className="pt-xxs">
                <div className="flex justify-between items-center mb-xxs">
                  <span className="font-caption-md text-caption-md text-graphite">
                    Strength:{" "}
                ...
                <p className="font-caption-sm text-caption-sm text-graphite mt-xs">
            ...
            <div className="pt-md">
              <button
                className="w-full h-[44px] bg-primary text-on-ink font-button-md text-button-md uppercase rounded-[4px] hover:bg-primary-deep transition-all duration-200 flex items-center justify-center gap-xs"
                type="submit"
              >
                Update Password
                <span
            ...
            <div className="text-center pt-md">
              <a
                className="font-caption-bold text-caption-bold text-primary hover:text-primary-deep transition-colors flex items-center justify-center gap-xxs"
                href="/login-portal"
              >
                <span
